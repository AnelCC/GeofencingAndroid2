...
import com.anelcc.geofencing.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, SavedStateViewModelFactory(this.application, this)).get(GeofenceViewModel::class.java)
            ...
            addOnCompleteListener {
                ...
                geofencingClient.addGeofences(getGeofencingRequest(currentGeofenceIndex), geofencePendingIntent)?.run {
                    ...
                    addOnFailureListener {
                        ...
                        Toast.makeText(this@MainActivity, R.string.geofences_not_added, Toast.LENGTH_LONG).show()
                        it?.let {
